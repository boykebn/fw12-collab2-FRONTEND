    ...
    <div className="font-rubik">
      ...
      <div className="px-[150px] absolute top-[4500px]">
        <div className="border-1 bg-white px-[70px] py-[58px] flex items-center rounded-[10px]">
          ...
          <div>
            <button className="text-white border-1 bg-[#7d6e83] py-[17px] px-[82px] rounded-[10px]">See Promo</button>
          </div>
        </div>
      </div>
      <footer className="bg-[#d0b8a8]">
        <div className="pt-[180px] px-[150px]">
          <div>
            <div className="flex items-center mb-[22px]">
              <Image src={logo} alt="logo" className="w-[30px] h-[33px] mr-[15px]" />
              <p className="text-[#0B132A] text-[20px] font-bold">Our Coffee</p>
            </div>
            <div className="mb-[45px]">
              <p className="text-[#4F5665] text-[16px] leading-[30px] w-[340px]">Coffee Shop is a store that sells some good meals, and especially coffee. We provide high quality beans</p>
            </div>
            <div className="flex">
              <div className="mr-[20px]">
                <FaFacebookF className="absolute left-[158px] top-[4994px]" />
                <div className="border-1 bg-[#7d6e83] w-[34px] h-[34px] rounded-[50%] \"></div>
              </div>
              <div className="mr-[20px]">
                <FaTwitter className="absolute left-[2008px] top-[4994px]" />
                <div className="border-1 bg-[#7d6e83] w-[34px] h-[34px] rounded-[50%] \"></div>
              </div>
              <div>
                <ImInstagram className="absolute left-[158px] top-[4994px]" />
                <div className="border-1 bg-[#7d6e83] w-[34px] h-[34px] rounded-[50%] \"></div>
              </div>
            </div>
          </div>
