...
import iconProfile from "../assets/profile-icon.png";
export default function Home() {
  return (
    <div className="font-rubik">
      ...
      <div>
        <div>
          <div className="border-1 bg-[#7d6e83] w-[55px] h-[55px] absolute rounded-[50%] left-[200px]"></div>
          <Image src={iconProfile} alt="profileIcon" className="" />
        </div>
      </div>
    </div>
  );
