...
export default function Home() {
  return (
    <div className="font-rubik">
      ...
      <div className="px-[90px] py-[53px] border-1 bg-white absolute left-[150px] top-[660px] rounded-[10px] flex items-center">
        <div className="flex">
          <div className="mr-[36px]">
            <FaUser className="w-[16px] h-[18px] absolute left-[100px] top-[100px]" />
        ...
        <div className="flex">
          <div className="mr-[36px]">
            <MdLocationOn className="w-[22px] h-[26px] absolute left-[491px] top-[100px]" />
            <div className="border-1 bg-[#7d6e83] w-[55px] h-[55px] rounded-[50%] \"></div>
          </div>
          <div className="mr-[134px]">
            <p className="text-[#0B132A] text-[25px] font-bold leading-[30px] mb-[5px]">90+</p>
        ...
        <div className="flex">
          <div className="mr-[36px]">
            <AiOutlineHeart className="w-[16px] h-[18px] absolute left-[850px] top-[100px]" />
            <div className="border-1 bg-[#7d6e83] w-[55px] h-[55px] rounded-[50%] \"></div>
          </div>
          <div className="mr-[134px]">
            <p className="text-[#0B132A] text-[25px] font-bold leading-[30px] mb-[5px]">90+</p>
