    ...
    <div className="font-rubik">
      ...
      <div className="bg-[#d0b8a8]">
        <div className="px-[150px]">
          <div className="border-1 bg-white px-[70px] py-[58px] flex items-center rounded-[10px] absolute">
            <div className="flex-1">
            ...
            <div>
              <button className="text-[#d0b8a8] border-1 bg-[#7d6e83] py-[17px] px-[82px] rounded-[10px]">See Promo</button>
            </div>
          </div>
        </div>
      </div>
