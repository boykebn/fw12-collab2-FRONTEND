  ...
  return (
    <div className="font-rubik">
      ...
      <div className="bg-[#f8ede3]">
        ...
        <div className="px-[150px] flex mb-[44px]">
          ...
          <div>
            <button className="border-2 border-[#7d6e83] bg-white py-[10px] px-[10px] rounded-[50%] mr-[40px]">
              <AiOutlineArrowLeft className="w-[20px] h-[17px]" />
            </button>
            <button className="border-2 border-[#7d6e83] bg-white py-[10px] px-[10px] rounded-[50%] hover:shadow-4xl">
