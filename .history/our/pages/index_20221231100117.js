...
export default function Home() {
  return (
    <div className="font-rubik">
      ...
      <div className="bg-[#f8ede3]">
        <div className="mb-[155px] text-center">
          <p className="text-[#0B132A] text-[35px] leading-[50px] font-bold mb-[20px] w-[385px] px-[496px]">Visit Our Store in the Spot on the Map Below</p>
          <p className="text-[#4F5665] text-[16px] leading-[30px] w-[555px] px-[442px]">See our store in every city on the spot and spen your good day there. See you soon!</p>
        </div>
      </div>
    </div>
  );
