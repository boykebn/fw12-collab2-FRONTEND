  ...
  return (
    <div className="font-rubik">
      ...
      <div className=" pt-[1045px] relative">
        ...
        <div className="px-[150px] flex mb-[35px]">
      ...
      <div className="px-[150px] relative pb-[100px]">
        <div className="border-1 bg-white px-[70px] py-[58px] flex items-center rounded-[10px] shadow-2xl">
          ...
          <div>
            <button className="text-white border-1 bg-[#7d6e83] py-[17px] px-[82px] rounded-[10px] w-full">
              See Promo
            </button>
          </div>
        </div>
      </div>
      <footer className="absolute w-full bg-[#dfd3c3]">
