    ...
    <div className="font-rubik">
      ...
      <div className="bg-[#f8ede3]">
        ...
        <div className="px-[175px] flex">
          <div className="border-2 bg-white rounded-[10px] pt-[62px] pl-[82px] pr-[65px] pb-[50px] mb-[30px]">
            ...
            <div className="flex items-center mb-[130px]">
              <div className="">
            ...
            <p className="text-[#0B132A] text-[25px] font-bold leading-[30px] text-center">IDR 25.000</p>
            <div className="flex justify-center">
              <button className="py-[13px] px-[46px] border-2 bg-white">Order Now</button>
            </div>
          </div>
        </div>
      </div>
