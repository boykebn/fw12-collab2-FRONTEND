...
export default function Home() {
  return (
    <div className="font-rubik">
      ...
      <div className="px-[150px] flex">
        <div className="border-2 p-[30px] flex items-center">
          <Image src={person1} alt="person1" className="mr-[21px]" />
          <div className="mr-[108px]">
            <p className="text-[#0B132A] text-[18px] leading-[30px] font-semibold">Viezh Robert</p>
            <p className="text-[14px] text-[#4F5665] leading-[30px]">Warsaw, Poland</p>
          </div>
          <div className="flex items-center">
            <p>4.5</p>
