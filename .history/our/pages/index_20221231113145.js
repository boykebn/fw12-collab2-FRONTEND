    ...
    <div className="font-rubik">
      ...
      <div className="bg-[#d0b8a8]">
        <div className="px-[150px]">
          <div className="border-1 bg-white px-[70px] py-[58px]">
            <div>
              <p className="text-[#0B132A] text-[35px] font-bold leading-[40px] mb-[20px] w-[371px]">Check our promo today!</p>
              <p className="text-[#4F5665] text-[16px] leading-[30px]">Let's see the deals and pick yours!</p>
            </div>
            <div>
