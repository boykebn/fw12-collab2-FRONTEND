...
export default function Home() {
  return (
    <div className="font-rubik">
      ...
      <div className="px-[150px] border-1 bg-white absolute left-[150px] top-[950px]">
        <div>
          <FaUser className="w-[16px] h-[18px] absolute left-[19px] " />
          <div className="border-1 bg-[#7d6e83] w-[55px] h-[55px] rounded-[50%] left-[200px]"></div>
        </div>
      </div>
    </div>
  );
