...
export default function Home() {
  return (
    <div className="font-rubik">
      ...
      <div className="bg-[#f8ede3]">
        <div className="mb-[155px] px-[442px] text-center">
          <p className="text-[#0B132A] text-[35px] leading-[50px] font-bold mb-[20px] w-[385px]">Visit Our Store in the Spot on the Map Below</p>
