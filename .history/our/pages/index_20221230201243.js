      ...
      <div className="bg-[url('../assets/background-home.png')] h-[645px]">
        <div className="px-[150px]">
          <div className="pt-[78px]">
            ...
            <p className="text-white text-[20px] font-bold leading-[30px] w-[555px]">We provide high quality beans, good taste, and healthy meals made by love just for you. Start your day with us for a bigger smile!</p>
          </div>
          <div></div>
        </div>
      </div>
