    ...
    <div className="font-rubik">
      ...
      <div className="bg-[#f8ede3]">
        ...
        <div className="px-[175px] flex">
          <div className="border-2 bg-white rounded-[10px] pt-[62px] pl-[82px] pr-[65px] pb-[50px] mb-[30px] text-center">
            <div className="mb-[30px]">
              <Image src={food1} alt="food1" className="rounded-[50%] shadow-xl mb-[53px] flex justify-center" />
