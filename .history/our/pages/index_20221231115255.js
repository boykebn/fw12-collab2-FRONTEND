      ...
      <footer className="bg-[#d0b8a8]">
        <div className="pt-[180px] px-[150px]">
          <div>
            ...
            <div>
              <p className="text-[#4F5665] text-[16px] leading-[30px]">Coffee Shop is a store that sells some good meals, and especially coffee. We provide high quality beans</p>
            </div>
          </div>
