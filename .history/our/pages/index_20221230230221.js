    ...
    <div className="font-rubik">
      ...
      <div className="bg-[#f8ede3]">
        ...
        <div className="px-[175px] flex">
          <div className="border-2 bg-white rounded-[10px] pt-[62px] pl-[82px] pr-[79px] pb-[50px]">
            <Image src={food1} alt="food1" className="rounded-[50%] shadow-lg mb-[23px]" />
            <p className="text-[18px]">Hazelnut Latte</p>
          </div>
        </div>
      </div>
    </div>
