      ...
      <div className="bg-[url('../assets/background-home.png')] h-[645px] ">
        <div className="px-[150px] flex">
          <div className="pt-[78px] mr-auto">
            ...
            <Link href="#" className="text-white text-[16px] font-bold border-1 px-[58px] py-[18px] bg-[#7d6e83] rounded-[10px]">
              Get Started
            </Link>
          </div>
          <div className="pt-[20px]">
            <Image src={search} alt="search" className="absolute top-[165px] right-[580px]" />
            <input placeholder="Search" className="focus:outline-none bg-[#f8ede3] py-[21px] pl-[75px] font-[900]" />
          </div>
        </div>
      </div>
    </div>
