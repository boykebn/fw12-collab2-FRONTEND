  ...
  return (
    <div className="max-w-full max-h-full font-poppins">
      ...
      <div className="bg-profile_bg bg-no-repeat bg-cover pb-[100px] ">
        ...
        <div className="pl-32 pt-20 pb-[40px] flex gap-10 ">
          <div className="flex w-[744px] h-[418px] bg-white rounded-lg border-t border-l border-r border-[12px] border-[#d0b8a8] py-[26px] pl-[31px]">
            <div>
