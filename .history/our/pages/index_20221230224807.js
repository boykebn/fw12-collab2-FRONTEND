        ...
        <div>
          ...
          <div className="flex">
            ...
            <div className="text-[#4F5665] text-[14px] leading-[30px]">
              <p className="mb-[18px]">High quality beans</p>
              <p className="mb-[18px]">Healthy meals, you can request the ingredients</p>
              <p className="mb-[18px]">Chat with our staff to get better experience for ordering</p>
