    ...
    <div className="font-rubik">
      ...
      <div className="pl-[90px] pr-[59px] py-[53px] border-1 bg-white absolute left-[150px] top-[660px] rounded-[10px] flex items-center shadow-lg mb-[103px]">
        ...
        <div className="flex">
          ...
          <div className="mr-[134px]">
            ...
            <p className="text-[#4F5665] text-[20px] leading-[30px]">Stores</p>
          </div>
        </div>
        <hr className="bg-[#EEEFF2] w-[2px] h-[125px] mr-[113px]" />
        <div className="flex">
      ...
      <div className="bg-[#f8ede3]">
        ...
        <div className="px-[150px] flex pb-[180px]">
          ...
          <div>
            <button className="border-2 border-[#7d6e83] bg-white py-[10px] px-[10px] rounded-[50%] mr-[40px] hover:bg-[#D0b8a8] hover:text-white hover:border-[#D0b8a8]">
