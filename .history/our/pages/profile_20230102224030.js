        ...
        <div className="pl-32 pt-20 flex gap-5 ">
          <div className="w-[310px] h-[358px] rounded-lg bg-white px-5 py-14 border-t border-l border-r border-[12px] border-[#d0b8a8]">
            <div className="flex justify-center items-end">
              ...
              />
              <div className=" absolute border-1 w-[30px] h-[30px] bg-[#d0b8a8] rounded-[50%] flex items-center justify-center mr-[-40px]">
                <MdOutlineModeEdit />
              </div>
            </div>

            <div className="flex flex-col justify-center items-center">
              <p className="text-xl font-bold pb-2 pt-4">{bio.firstName}</p>
              <p>{bio.email}</p>
