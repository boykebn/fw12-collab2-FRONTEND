...
export default function Home() {
  return (
    <div className="font-rubik">
      <div className="px-3 md:px-[150px] py-5 md:py-[45px] md:flex ">
        ...
        <div className=" text-[#4F5665] text-[16px] md:mr-[153px] mb-5 md:mb-0 flex justify-center">
        ...
        <div className="text-[16px] font-[600] leading-[19px] text-center">
      ...
      <div className="bg-[url('../assets/background-home.png')] h-[645px] absolute w-full ">
        <div className="px-3 md:px-[150px] md:flex">
          <div className="pt-[78px] mr-auto mb-5 md:mb-0">
            <p className="text-white text-[22px] md:text-[50px] font-bold leading-[70px]  md:w-[570px] mb-[20px]">
              Start Your Day with Coffee and Good Meals
            </p>
            <p className="text-white text-[20px] font-bold leading-[30px] md:w-[555px] mb-[32px]">
          ...
          <div className="pt-[20px]">
            <Image
              src={search}
              alt="search"
              className="absolute top-[40px] right-[420px] hidden md:block"
            />
            <input
              placeholder="Search"
              className="focus:outline-none bg-[#f8ede3] py-[17px] pl-[10px] md:pl-[75px] font-[900] rounded-[30px]"
            />
          </div>
        </div>
        <div className="px-3 md:px-[150px] pt-[135px]">
          <div className="pl-[90px] pr-[59px] py-[53px] border-1 bg-white  rounded-[10px] md:flex items-center shadow-lg mb-[103px]">
            ...
            <hr className="bg-[#EEEFF2] w-[2px] h-[125px] mr-[80px] hidden md:block" />
            <div className="flex mr-[134px] mb-5 md:mb-0">
              <div className="mr-[36px]">
      ...
      <div className="pt-[900px] md:pt-[870px] px-3 md:px-[150px] md:flex mb-[82px]">
      ...
      <div className="bg-[#f8ede3] md:absolute md:h-[1250px] md:mb-[400px] w-full">
        ...
        <div className="md:flex pl-3 md:pl-[100px]">
          <div className=" flex md:mr-[50px] justify-center">
      ...
      <div className=" pt-[1045px] md:relative">
