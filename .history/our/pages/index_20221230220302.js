    ...
    <div className="font-rubik">
      ...
      <div className="bg-[url('../assets/background-home.png')] h-[645px] ">
        <div className="px-[150px] flex">
          <div className="pt-[78px] mr-auto mb-[115px]">
      ...
      <div className="px-[90px] py-[73px] border-1 bg-white absolute left-[150px] top-[750px]">
        <div className="flex">
          <div className="mr-[36px]">
            <FaUser className="w-[16px] h-[18px] absolute left-[110px] top-[90px]" />
            <div className="border-1 bg-[#7d6e83] w-[55px] h-[55px] rounded-[50%] \"></div>
          </div>
          <div>
            <p className="text-[#0B132A] text-[25px] font-bold leading-[30px]">90+</p>
