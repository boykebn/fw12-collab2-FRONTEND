    ...
    <div className="font-rubik">
      ...
      <div className="bg-[#f8ede3]">
        ...
        <div className="px-[150px]">
          <div className="">
            <button className="border-1 bg-[#7d6e83] w-[30px] h-[15px] rounded-[10px] mr-[25px]"></button>
            <button onClick="#" className="border-1 bg-[#D0b8a8] w-[15px] h-[15px] rounded-[50%] mr-[25px]"></button>
            <button onClick="#" className="border-1 bg-[#D0b8a8] w-[15px] h-[15px] rounded-[50%] mr-[25px]"></button>
