  ...
  return (
    <div className="font-rubik">
      ...
      <div className="bg-[#f8ede3]">
        ...
        <div className="px-[150px] flex">
          <div className="border-2 bg-white rounded-[10px] p-[30px] flex items-center">
            ...
            <div>
              <p className="text-[#0B132A] text-[16px] leading-[30px]">“Wow... I am very happy to spend my whole day here. the Wi-fi is good, and the coffee and meals tho. I like it here!! Very recommended!</p>
            </div>
          </div>
        </div>
      </div>
