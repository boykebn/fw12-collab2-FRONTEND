  ...
  return (
    <div className="pt-[100px] font-poppins">
      <div className="bg-[url('../assets/background-chat.png')] bg-cover bg-no-repeat">
        <div className="pt-[84px] px-[200px] flex border-2 rounded-[20px]">
          <div className=" py-[60px] px-[50px]  bg-[#d0b8a8]">
          ...
          <div className="bg-white">
            <div>
              <p className="text-[#4F5665] text-[30px] font-bold leading-[45px]">
                Room Chat
              </p>
            </div>
          </div>
