...
export default function Home() {
  return (
    <div className="font-rubik">
      ...
      <div className="pt-[193px] px-[150px] flex">
        ...
        <div>
          ...
          <div className="flex">
            ...
            <div className="text-[#4F5665] text-[14px] leading-[30px]">
              <p className="mb-[20px]">High quality beans</p>
              <p className="mb-[20px]">Healthy meals, you can request the ingredients</p>
              <p className="mb-[20px]">Chat with our staff to get better experience for ordering</p>
