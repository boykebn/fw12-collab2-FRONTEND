...
export default function Home() {
  return (
    <div className="font-rubik">
      ...
      <div className="pt-[193px] px-[150px]">
        <div>
          <Image src={layer2} alt="img-layer-2" />
        </div>
        <div>
          <div>
            <p className="text-[#0B132A] text-[35px] font-[500] leading-[50px] ">We Provide Good Coffee and Healthy Meals</p>
            <p className="text-[#4F5665] text-[16px] leading-[30px]">You can explore the menu that we provide with fun and have their own taste and make your day better.</p>
          </div>
        </div>
      </div>
    </div>
