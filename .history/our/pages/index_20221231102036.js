    ...
    <div className="font-rubik">
      ...
      <div className="bg-[#f8ede3]">
        ...
        <div className="text-center">
          <p className="text-[#0B132A] text-[35px] leading-[50px] font-bold w-[447px] pl-[470px]">Loved by Thousands of Happy Customer</p>
          <p className="text-[#4F5665] text-[16px] leading-[30px]">These are the stories of our customers who have visited us with great pleasure.</p>
        </div>
      </div>
    </div>
  );
