    ...
    <div className="max-w-full max-h-full font-poppins">
      ...
      <div className="bg-profile_bg bg-no-repeat bg-cover pb-[100px] ">
          ...
          <div className="w-[802px] h-[358px] rounded-lg bg-white flex py-[17px] px-[30px] border-t border-l border-r border-[12px] border-[#d0b8a8]">
            <div className="w-[340px] mr-[36px]">
              ...
              <div className="flex flex-col mb-[47px]">
                <span className="text-[#9F9F9F] text-[20px] font-[500] mb-[13px]">
                  Email adress :
                </span>
                <span className="text-[20px] font-rubik mb-[10px]">
        ...
        <div className="pl-32 pt-20 flex gap-10 ">
          <div className="w-[744px] h-[418px] bg-white rounded-lg border-t border-l border-r border-[12px] border-[#d0b8a8] py-[26px] pl-[31px]">
            <div>
              ...
              <div className="flex flex-col">
                <span className="text-[#9F9F9F] text-[20ppx] font-[500] mb-[13px]">
                  Display name :
                </span>
                <span className="text-[#000000] text-[20px] font-rubik">
                  Zulaikha
                </span>
              </div>
            </div>
