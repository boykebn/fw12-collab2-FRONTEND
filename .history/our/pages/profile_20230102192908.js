      ...
      <div className="bg-profile_bg bg-no-repeat bg-cover pb-[100px] ">
        ...
        <div className="pl-32 pt-20 flex gap-10 ">
          ...
          <div>
            ...
            <div className="pt-5">
              <button className="py-[17px] w-full rounded-[20px] bg-[#d0b8a8] border-1 font-bold hover:bg-[#7d6e83] hover:text-white">
                Save Change
              </button>
            </div>
            <div className="pt-5">
              <button className="py-[17px] w-full rounded-[20px] bg-[#d0b8a8] border-1 font-bold hover:bg-[#7d6e83] hover:text-white"">Cancel</button>
            </div>
            <div className="pt-5">
