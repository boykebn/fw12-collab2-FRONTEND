        ...
        <div className="px-[175px] flex">
          <div className="border-2 bg-white rounded-[10px] pt-[62px] pl-[82px] pr-[79px] pb-[50px] mb-[30px]">
            ...
            <div className="flex items-center">
              <div className="mr-[13px]">
                <Image src={ceklis2} alt="ceklis2" className="mb-[30px] pt-[5px]" />
                <Image src={ceklis2} alt="ceklis2" className="mb-[30px]" />
                <Image src={ceklis2} alt="ceklis2" className="mb-[30px]" />
                <Image src={ceklis2} alt="ceklis2" />
              </div>
              <div className="text-[#4F5665] text-[14px]">
                <p className="mb-[15px]">HazelnutSyrup</p>
                <p className="mb-[15px]">Wanilla Whipped Cream</p>
                <p className="mb-[15px]">Ice / Hot</p>
