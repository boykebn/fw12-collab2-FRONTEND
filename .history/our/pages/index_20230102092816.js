...
export default function Home() {
  return (
    <div className="font-rubik">
      ...
      <div className="bg-[url('../assets/background-home.png')] h-[645px] absolute w-screen overscroll-x-none">
      ...
      <div className="bg-[#f8ede3] absolute h-[1250px] mb-[400px] w-screen overscroll-x-none">
      ...
      <div className="px-[150px] absolute mt-[-100px] w-screen overscroll-x-none">
