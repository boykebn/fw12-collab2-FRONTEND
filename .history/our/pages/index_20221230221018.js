...
export default function Home() {
  return (
    <div className="font-rubik">
      ...
      <div className="px-[90px] py-[73px] border-1 bg-white absolute left-[150px] top-[650px] rounded-[10px] flex items-center">
        <div className="flex">
          <div className="mr-[36px]">
            <FaUser className="w-[16px] h-[18px] absolute left-[110px] top-[120px]" />
