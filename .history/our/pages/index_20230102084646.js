...
export default function Home() {
  return (
    <div className="font-rubik">
      <div className="md:px-[150px] py-5 md:py-[45px] flex flex-col items-center justify-center">
        ...
        <div className=" text-[#4F5665] text-[16px] mr-[153px] mb-5 md:mb-0 flex flex-col">
