...
export default function Home() {
  return (
    <div className="font-rubik">
      ...
      <div className="bg-[url('../assets/background-home.png')] h-[645px] absolute w-screen z-[-1]">
      ...
      <div className="bg-[#f8ede3] absolute h-[1250px] mb-[400px] w-screen z-[-1]">
      ...
      <div className="px-[150px] absolute mt-[-100px] w-screen z-[-1]z-[-1]">
