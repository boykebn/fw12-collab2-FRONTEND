...
const EditProduct = () => {
  ...
  const editProduct = async () => {
    try {
      const response = await http(token).patch(`/product/edit/${pid}`, {
        name,
        description,
        stock,
      });
  ...
  const [showMessageSuccessDelete, setShowMessageSuccessDelete] =
    React.useState("");
  ...
  return (
    <div className="relative">
      {showDeleteOption ? (
        <>
          <div className="absolute top-0 h-full w-screen bg-[#060606] opacity-80 z-10"></div>
            ...
            <div className="flex gap-10">
              <div>
                <button
                  ...
                  className="btn btn-outline border-2-[#7D6E83]"
                >
                  Cancel
                </button>
              </div>
              <div>
                <button
                  ...
                  type="button"
                  className="btn bg-[#7D6E83] border-2-[#7D6E83]"
                >
                  Delete
                </button>
              </div>
        ...
        <div className="flex flex-col md:flex-row gap-1">
          <div className="flex-[4%]">
            ...
            <div className="flex flex-col justify-center items-center mt-[40px]">
              <div className="relative w-fit">
                <div
                  ...
                  className="absolute top-5 right-5 border-1 w-[50px] h-[50px] rounded-[50%] bg-red-300 flex justify-center items-center cursor-pointer"
                >
            ...
            <div className="pt-10 text-xl">
              <div>
                Delivery only on <span className="font-bold">Monday to</span>{" "}
              </div>
              <div>
                <span className="font-bold">friday</span> at{" "}
          ...
          <div className="flex-[55%] w-[200px] md:w-[500px]">
            <div className="">
              <div className="pb-5 border-b-2 border-black">
                <input
                  ...
                  type="text"
                  className="text-6xl font-[900] bg-transparent focus:outline-none w-[200px] md:w-28"
              ...
              <div className="pt-5 pb-5 border-b-2 border-black">
                <input
                  ...
                  className="text-4xl bg-transparent focus:outline-none w-[200px] md:w-28"
              ...
              <div className="pt-5 pb-5 border-b-2 border-black">
                <input
                  ...
                  className="input bg-transparent focus:outline-none font-normal text-2xl"
            ...
            <div className="pt-10">
              <select
                ...
                className="input input-lg py-5 px-5 decoration-none rounded-lg focus:outline-none"
            ...
            <div className="pt-5">
              <select
                ...
                className="input input-lg py-5 px-5 decoration-none rounded-lg focus:outline-none"
                defaultValue={product?.deliveryMethodId}
              >
                <option value="" disabled selected hidden>
            ...
            <div className="pt-5 flex justify-center gap-5">
              <div className="flex items-center justify-center gap-5 border bg-white rounded-xl text-3xl font-bold px-10 py-3">
                ...
                <div className="w-8 text-center" defaultValue={product?.value}>
                  {stock}
                </div>
                <div
                  onClick={() => setStock(stock + 1)}
              ...
              <div className="hidden">
                <button className="btn btn-lg text-2xl font-bold">
                  Add to Cart
                </button>
              </div>
            </div>
            ...
            <button
              onClick={editProduct}
              className="btn btn-lg text-2xl font-bold mt-5"
            >
              Save change
            </button>
          </div>
