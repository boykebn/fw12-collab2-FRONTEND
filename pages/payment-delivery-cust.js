        ...
        <div className="grid grid-cols-[720px_minmax(720px,_1fr)] max-h-screen pb-32">
          ...
          <div className="pl-32 pt-[95px]">
            <div className="w-[316px]">
              <p className="text-4xl text-white font-bold drop-shadow-2xl shadow-black-500">
          ...
          <div className="pl-32 pt-[230px]">
            ...
            <div className="flex flex-col px-10 py-10 w-[454px] h-[198px] rounded-xl bg-white mt-5 text-xl font-semibold leading-8">
              <p className="flex-1">
                {" "}
                <span className="text-black font-bold">Delivery</span> to{" "}
                {profile.address}
              </p>
              <hr />
              <p className="flex-1 flex grow items-end">
                {profile.phoneNumber}
              </p>
            </div>
            ...
            {successMessage ? (
              <div className="alert alert-success shadow-lg mt-3 w-[75%]">
                <div>
                  <svg
            ...
            {errorMessage ? (
              <div className="alert alert-error shadow-lg mt-3 w-[75%]">
                <div>
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    className="stroke-current flex-shrink-0 h-6 w-6"
            ...
            <div className="px-10 py-10 w-[454px] h-[259px] rounded-xl bg-white mt-5 text-xl font-semibold leading-8">
              ...
              <hr />
              <div
                className="flex items-center gap-5 pt-5 pb-5"
            ...
            <div className="w-[454px] mr-10">
              <button
                onClick={pay}
                className="mt-10 btn h-[60px] text-lg font-semibold"
              >
                Confirm and Pay
              </button>
            </div>
