    ...
    <section className='bg-[#F8EDE3] px-5 md:px-28 py-10 border-b-2'>
      ...
      <div className='flex flex-col gap-5'>
        <div className='hidden md:block text-center'>
          <h3 className='font-bold text-2xl text-[#7D6E83]'>See how your store progress so far</h3>
        </div>
      ...
      <div className='flex flex-col md:flex-row gap-8 py-8'>
        <div className='flex-[70%] bg-white rounded-2xl shadow-xl px-8 py-5'>
          ...
          <div className='flex flex-col gap-3 items-center'>
            <div className='border-b'>
              <Image src={require('../images/chart.png')} alt='Chart' className='w-4/4 py-10'/>
            </div>
        ...
        <div className='md:hidden flex-[70%] bg-white rounded-2xl shadow-xl px-8 py-5'>
          ...
          <div className='flex flex-col gap-3 items-center'>
            <div className='border-b'>
              <Image src={ChartDailyAvg} alt='Chart' className='w-4/4 py-10'/>
            </div>
          </div>
        </div>
          ...
          <div className='hidden md:block bg-white rounded-xl shadow-lg p-5'>
            <div className='flex gap-5 border-b pb-3'>
              <div className='w-14 h-14'>
                <Image src={require('../images/profile2.png')} alt='profile' className='rounded-full w-full'/>
              </div>
              <div>
